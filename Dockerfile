...
RUN wget https://github.com/helmfile/helmfile/releases/download/v0.149.0/helmfile_0.149.0_linux_amd64.tar.gz -O - | tar -xzO helmfile_0.149.0_linux_amd64/helmfile > /usr/local/bin/helmfile
